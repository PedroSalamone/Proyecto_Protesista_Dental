...
def send_message_view(request, recipient_id):
    ...
    if request.method == "POST":
        ...
        form = MessageForm()
    return render(
        request, "blog/send_message.html", {"form": form, "recipient": recipient}
    )
...
def lista_publicaciones(request):
    ...
    return render(
        request,
        "blog/lista_publicaciones.html",
        {"publicaciones": publicaciones, "form": form},
    )
